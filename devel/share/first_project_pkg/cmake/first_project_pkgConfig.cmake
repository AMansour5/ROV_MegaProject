...
if(NOT "/home/mypi/kady_hossam_naggar/devel/include " STREQUAL " ")
  set(first_project_pkg_INCLUDE_DIRS "")
  set(_include_dirs "/home/mypi/kady_hossam_naggar/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'first_project_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mypi/kady_hossam_naggar/src/first_project_pkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mypi/kady_hossam_naggar/devel/lib;/home/mypi/kady_hossam_naggar/devel/lib;/opt/ros/noetic/lib)
